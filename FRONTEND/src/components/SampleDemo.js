                            ...
                            <div className="p-messages-wrapper">
                                <ul>
                                    <li>
                                        ...
                                        <span className="p-messages-detail">Avalon provides a theme for all 70+ PrimeReact Components. This page contains samples of the commonly used components for demo purposes.</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
