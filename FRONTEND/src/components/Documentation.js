...
`}
                        ...
                        <h1>Dependencies</h1>
                        <p>Dependencies of Avalon are listed below and needs to be added to package.json. Avalon has no direct dependency, even PrimeReact components are an optional dependency.</p>
...
`}
                        ...
                        <p>Avalon offers bootstrap 3 and 4 styling options for both the theme and layout. Default one is bootstrap 4 and adding "-v4" suffix to the files you use to enables V4 support such as layout-blue-v4.css for the layout and theme-blue-v4.css for the theme.
...
`
                        ...
                        <h3>sass/variables/_common-v4.scss</h3>
<CodeHighlight lang="css">
{
...
`
                        ...
                        <h3>sass/theme-v4/_variables.scss</h3>
<CodeHighlight lang="css">
{
`@import '../variables/common-v4';
...
/* Messages */
$infoMessageBgColor:#d9edf7;
$infoMessageBorderColor:#bcdff1;
$infoMessageTextColor:#31708f;
$warnMessageBgColor:#fcf8e3;
$warnMessageBorderColor:#faf2cc;
$warnMessageTextColor:#8a6d3b;
$errorMessageBgColor:#f2dede;
$errorMessageBorderColor:#ebcccc;
$errorMessageTextColor:#a94442;
$fatalMessageBgColor:#999999;
...
`
                        ...
                        <p>Badges are numerical indicators associated with a link defined using the badge property.</p>
<pre>
label: 'Components', icon: 'list', badge: '2'
</pre>
...
&lt;div className="layout-menu-container layout-menu-dark"&gt;
                        ...
                        <p>Avalon uses PrimeFlex Grid System throughout the samples, although any Grid library can be used we suggest using PrimeFlex as your grid system as it is well tested and supported by PrimeReact. PrimeFlex is
                        available at npm and defined at package.json of Avalon so that it gets installed by default.</p>

                        <h1>Customizing Styles</h1>
                        <p>It is suggested to write your customizations in <i>_layout_styles.scss</i> and <i>_theme_styles.scss </i> files for seamless updates
