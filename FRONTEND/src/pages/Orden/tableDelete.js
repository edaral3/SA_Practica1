...
const createBody = (
    ...
    <TableRow key={`tr-${index}`} selectable={"false"}>
        ...
        {deleteRowOfTable(data, index, deleteRow, deleteOrden)}
        {deleteRowOfTableDelete(data, index, deleteRow, deleteOrden)}
...
const deleteRowOfTableDelete = (data, index, deleteOrden) => {
    return (
        <TableCell>
            <DeleteForeverIcon onClick={() => deleteOrden(data.id, index)} />
        </TableCell>
    )
};
            ...
            <Table className={classes.table} aria-label="caption table">
                <TableHead>
                    <TableRow>
                        ...
                        <TableCell>{"ELIMINAR ORDEN"}</TableCell>
                    </TableRow>
                </TableHead>
                <TableBody>
                    {
